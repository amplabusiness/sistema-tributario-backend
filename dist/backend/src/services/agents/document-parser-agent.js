...
class DocumentParserAgent {
    ...
    async start() {
        if (this.isRunning) {
            (0, logger_1.logInfo)('Agente de parsing já está em execução');
            return;
        }
        this.isRunning = true;
        (0, logger_1.logInfo)('🚀 Iniciando Agente de Parsing de Documentos', {
    ...
    async stop() {
        this.isRunning = false;
        (0, logger_1.logInfo)('🛑 Agente de Parsing parado');
    }
    async processarDocumento(arquivoPath, tipo, empresa, cnpj, periodo) {
        ...
        if (processedCache.has(documentoId)) {
            (0, logger_1.logInfo)('Documento já processado anteriormente', { documentoId });
        ...
        try {
            (0, logger_1.logInfo)('Iniciando processamento de documento', {
                documentoId,
                tipo,
                empresa,
                arquivoPath,
            ...
            (0, logger_1.logError)('Erro ao processar documento', {
                documentoId,
                tipo,
                empresa,
    ...
    async processarXML(conteudo) {
        try {
            ...
            (0, logger_1.logError)('Erro ao processar XML', {
                error: error instanceof Error ? error.message : 'Unknown error',
            });
            throw error;
        }
    ...
    async processarSPED(conteudo) {
        try {
            ...
            (0, logger_1.logError)('Erro ao processar SPED', {
                error: error instanceof Error ? error.message : 'Unknown error',
            });
            throw error;
        }
    ...
    async processarECD(conteudo) {
        try {
            ...
            (0, logger_1.logError)('Erro ao processar ECD', {
                error: error instanceof Error ? error.message : 'Unknown error',
            });
            throw error;
        }
    ...
    async processarECF(conteudo) {
        try {
            ...
            (0, logger_1.logError)('Erro ao processar ECF', {
                error: error instanceof Error ? error.message : 'Unknown error',
            });
            throw error;
        }
    ...
    async processarCIAP(conteudo) {
        try {
            ...
            (0, logger_1.logError)('Erro ao processar CIAP', {
                error: error instanceof Error ? error.message : 'Unknown error',
            });
            throw error;
        }
    ...
    async processarInventario(conteudo) {
        try {
            ...
            (0, logger_1.logError)('Erro ao processar Inventário', {
                error: error instanceof Error ? error.message : 'Unknown error',
            });
            throw error;
        }
    ...
    async processarPGDAS(conteudo) {
        try {
            ...
            (0, logger_1.logError)('Erro ao processar PGDAS', {
                error: error instanceof Error ? error.message : 'Unknown error',
            });
            throw error;
        }
    ...
    async validarDadosComIA(dados, tipo) {
        try {
            ...
            (0, logger_1.logError)('Erro na validação IA', {
                error: error instanceof Error ? error.message : 'Unknown error',
            });
    ...
    async salvarNoBanco(documento) {
        (0, logger_1.logInfo)('Salvando documento no banco', {
    ...
    startProcessing() {
        (0, logger_1.logInfo)('Processamento em background iniciado');
    }
    getStatus() {
        return {
