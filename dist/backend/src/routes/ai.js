...
router.post('/analisar-documento', [
    ...
    try {
        ...
        (0, logger_1.logInfo)('Iniciando análise de documento fiscal', {
            tipoDocumento,
        ...
        (0, logger_1.logError)('Erro ao analisar documento fiscal', {
...
router.post('/validar-dados', [
    ...
    try {
        ...
        (0, logger_1.logInfo)('Iniciando validação de dados fiscais', {
            tipoValidacao,
        ...
        (0, logger_1.logError)('Erro ao validar dados fiscais', {
            error: error instanceof Error ? error.message : 'Unknown error',
        });
        res.status(constants_1.HTTP_STATUS.INTERNAL_SERVER_ERROR).json({
            success: false,
...
router.post('/gerar-relatorio', [
    ...
    try {
        ...
        (0, logger_1.logInfo)('Iniciando geração de relatório fiscal', {
            tipoRelatorio,
            campos: Object.keys(dados),
        });
        ...
        (0, logger_1.logError)('Erro ao gerar relatório fiscal', {
            error: error instanceof Error ? error.message : 'Unknown error',
        });
        res.status(constants_1.HTTP_STATUS.INTERNAL_SERVER_ERROR).json({
            success: false,
...
router.post('/analisar-xml', [
    ...
    try {
        ...
        (0, logger_1.logInfo)('Iniciando análise de XML/SPED', {
            tipo,
        ...
        (0, logger_1.logError)('Erro ao analisar XML', {
            error: error instanceof Error ? error.message : 'Unknown error',
        });
        res.status(constants_1.HTTP_STATUS.INTERNAL_SERVER_ERROR).json({
            success: false,
...
router.post('/corrigir-erros', [
    ...
    try {
        ...
        (0, logger_1.logInfo)('Iniciando correção de erros', {
        ...
        (0, logger_1.logError)('Erro ao corrigir erros', {
            error: error instanceof Error ? error.message : 'Unknown error',
        });
        res.status(constants_1.HTTP_STATUS.INTERNAL_SERVER_ERROR).json({
            success: false,
...
router.post('/requisicao-customizada', [
    ...
    try {
        ...
        (0, logger_1.logInfo)('Iniciando requisição customizada', {
        ...
        (0, logger_1.logError)('Erro na requisição customizada', {
            error: error instanceof Error ? error.message : 'Unknown error',
        });
        res.status(constants_1.HTTP_STATUS.INTERNAL_SERVER_ERROR).json({
            success: false,
...
router.get('/status', async (req, res) => {
    try {
        ...
        (0, logger_1.logError)('Erro ao verificar status da IA', {
            error: error instanceof Error ? error.message : 'Unknown error',
        });
        res.status(constants_1.HTTP_STATUS.INTERNAL_SERVER_ERROR).json({
            success: false,
...
router.get('/estatisticas', (req, res) => {
    try {
        ...
        (0, logger_1.logError)('Erro ao obter estatísticas da IA', {
            error: error instanceof Error ? error.message : 'Unknown error',
        });
        res.status(constants_1.HTTP_STATUS.INTERNAL_SERVER_ERROR).json({
            success: false,
