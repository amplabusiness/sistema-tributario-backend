...
const cacheMiddleware = (options = {}) => {
    return async (req, res, next) => {
        ...
        try {
            ...
            if (cachedData) {
                (0, logger_1.logInfo)('Cache hit', { key: cacheKey, url: req.originalUrl });
            ...
            res.json = function (data) {
                ...
                cache_1.default.setWithTags(cacheKey, data, options.tags || ['api'], options.ttl || 300).catch(error => {
                    (0, logger_1.logInfo)('Cache save failed', { key: cacheKey, error: error.message });
                });
            ...
            (0, logger_1.logInfo)('Cache middleware error', { key: cacheKey, error: error instanceof Error ? error.message : 'Unknown error' });
            next();
        }
    };
};
        ...
        res.json = function (data) {
            ...
            if (res.statusCode >= 200 && res.statusCode < 300) {
                cache_1.default.invalidateByTags(tags).catch(error => {
                    (0, logger_1.logInfo)('Cache invalidation failed', { tags, error: error instanceof Error ? error.message : 'Unknown error' });
                });
            }
            return originalSend.call(this, data);
        };
