...
router.get('/overview', auth_1.authenticateToken, async (req, res) => {
    try {
        ...
        (0, logger_1.logInfo)('Dashboard overview solicitado', {
            empresa,
            periodo,
            userId: req.user?.id
        });
        ...
        (0, logger_1.logError)('Erro ao buscar overview do dashboard', error instanceof Error ? error : new Error('Unknown error'));
...
router.get('/produtos', auth_1.authenticateToken, async (req, res) => {
    try {
        ...
        (0, logger_1.logInfo)('Dashboard produtos solicitado', {
            empresa,
            periodo,
            produto,
            userId: req.user?.id
        ...
        (0, logger_1.logError)('Erro ao buscar dados de produtos', error instanceof Error ? error : new Error('Unknown error'));
        res.status(constants_1.HTTP_STATUS.INTERNAL_SERVER_ERROR).json({
            success: false,
            error: constants_1.MESSAGES.ERROR.INTERNAL_ERROR,
            message: 'Erro interno do servidor',
...
router.get('/relatorios', auth_1.authenticateToken, async (req, res) => {
    try {
        ...
        (0, logger_1.logInfo)('Relatórios solicitados', {
            empresa,
            periodo,
            tipo,
            userId: req.user?.id
        ...
        (0, logger_1.logError)('Erro ao buscar relatórios', error instanceof Error ? error : new Error('Unknown error'));
        res.status(constants_1.HTTP_STATUS.INTERNAL_SERVER_ERROR).json({
            success: false,
            error: constants_1.MESSAGES.ERROR.INTERNAL_ERROR,
            message: 'Erro interno do servidor',
...
router.get('/alertas', auth_1.authenticateToken, async (req, res) => {
    try {
        ...
        (0, logger_1.logInfo)('Alertas solicitados', {
            empresa,
            severidade,
            userId: req.user?.id
        });
        ...
        (0, logger_1.logError)('Erro ao buscar alertas', error instanceof Error ? error : new Error('Unknown error'));
        res.status(constants_1.HTTP_STATUS.INTERNAL_SERVER_ERROR).json({
            success: false,
            error: constants_1.MESSAGES.ERROR.INTERNAL_ERROR,
            message: 'Erro interno do servidor',
