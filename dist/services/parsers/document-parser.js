...
class DocumentParser {
    ...
    async parseDocument(filePath) {
        ...
        (0, logger_1.logInfo)(`Iniciando parsing do documento: ${fileName}`, { filePath, fileType: fileExtension });
        try {
            ...
            (0, logger_1.logInfo)(`Documento parseado com sucesso: ${fileName}`, {
            ...
            (0, logger_1.logError)(`Erro ao fazer parsing do documento: ${fileName}`, { error, filePath });
            throw error;
        }
    }
