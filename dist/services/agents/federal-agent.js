...
class FederalAgent {
    ...
    async saveResults(results) {
        for (const result of results) {
            await database_1.prisma.federalResult.create({
                data: {
                    ...
                    cfop: result.cfop,
                    cst: result.cst,
                    pisBaseCalculo: result.calculo.pis.baseCalculo,
                    pisAliquota: result.calculo.pis.aliquota,
                    pisValor: result.calculo.pis.valorPIS,
                    pisCreditoPresumido: result.calculo.pis.creditoPresumido,
                    pisCreditoInsumos: result.calculo.pis.creditoInsumos,
                    pisCreditoEnergia: result.calculo.pis.creditoEnergia,
                    pisCreditoFrete: result.calculo.pis.creditoFrete,
                    pisCreditoEmbalagens: result.calculo.pis.creditoEmbalagens,
                    cofinsBaseCalculo: result.calculo.cofins.baseCalculo,
                    cofinsAliquota: result.calculo.cofins.aliquota,
                    cofinsValor: result.calculo.cofins.valorCOFINS,
                    cofinsCreditoPresumido: result.calculo.cofins.creditoPresumido,
                    cofinsCreditoInsumos: result.calculo.cofins.creditoInsumos,
                    cofinsCreditoEnergia: result.calculo.cofins.creditoEnergia,
                    cofinsCreditoFrete: result.calculo.cofins.creditoFrete,
                    cofinsCreditoEmbalagens: result.calculo.cofins.creditoEmbalagens,
                    irpjBaseCalculo: result.calculo.irpj.baseCalculo,
                    irpjAliquota: result.calculo.irpj.aliquota,
                    irpjValor: result.calculo.irpj.valorIRPJ,
                    irpjIsencao: result.calculo.irpj.isencao,
                    irpjReducao: result.calculo.irpj.reducao,
                    csllBaseCalculo: result.calculo.csll.baseCalculo,
                    csllAliquota: result.calculo.csll.aliquota,
                    csllValor: result.calculo.csll.valorCSLL,
                    csllIsencao: result.calculo.csll.isencao,
                    csllReducao: result.calculo.csll.reducao,
