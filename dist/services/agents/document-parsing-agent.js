...
class DocumentParsingAgent {
    ...
    async processDocument(filePath) {
        ...
        try {
            (0, logger_1.logInfo)(`Agente 2 iniciando processamento: ${filePath}`);
            ...
            if (companyData.cnpj) {
                ...
                if (!empresa) {
                    (0, logger_1.logInfo)(`Empresa não encontrada, cadastrando automaticamente: ${companyData.cnpj}`);
                    ...
                    (0, logger_1.logInfo)(`Empresa cadastrada automaticamente: ${empresa.id}`);
                }
            ...
            (0, logger_1.logInfo)(`Agente 2 concluído com sucesso: ${filePath}`, {
            ...
            (0, logger_1.logError)(`Erro no Agente 2: ${filePath}`, { error, result });
            return result;
        }
    }
    async processBatch(filePaths) {
        ...
        const startTime = Date.now();
        (0, logger_1.logInfo)(`Agente 2 iniciando processamento em lote: ${filePaths.length} arquivos`);
        const batchResult = {
            batchId,
        ...
        try {
            ...
            (0, logger_1.logInfo)(`Agente 2 lote concluído: ${batchId}`, {
            ...
            (0, logger_1.logError)(`Erro no processamento em lote: ${batchId}`, { error });
            throw error;
        }
    }
    async extractCompanyDataFromDocuments(companyId) {
        ...
        try {
            ...
            (0, logger_1.logInfo)(`Dados cadastrais consolidados para empresa: ${companyId}`, {
                dataSources,
            ...
            (0, logger_1.logError)(`Erro ao extrair dados cadastrais: ${companyId}`, { error });
            throw error;
        }
    }
    async validateAndCorrectData(documentId) {
        (0, logger_1.logInfo)(`Validando e corrigindo dados: ${documentId}`);
        try {
            ...
            (0, logger_1.logInfo)(`Validação e correção concluída: ${documentId}`, {
                validationErrors: result.validationErrors.length,
            ...
            (0, logger_1.logError)(`Erro na validação e correção: ${documentId}`, { error });
            throw error;
        }
    }
    async generateExtractionReport(companyId, dateRange) {
        ...
        try {
            ...
            (0, logger_1.logInfo)(`Relatório de extração gerado`, {
            ...
            (0, logger_1.logError)(`Erro ao gerar relatório de extração`, { error });
            throw error;
        }
    }
